...
type CartItemProps = {
    id: string, type: string, title: string, price: number, count: number, imageUrl: string, size: number,
}

const CartItem: React.FC<CartItemProps> = ({id, type, title, price, count, imageUrl, size}) => {
